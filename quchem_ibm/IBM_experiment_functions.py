...
def run_VQE_unitary_part_experiments(method_name, qc_circuit_dictionary_list, my_provider, n_shots, n_system, I_term,
    ...
    if save:
        ...
        F_name = 'method={}___time={}'.format(method_name, time)
