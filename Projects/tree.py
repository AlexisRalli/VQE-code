...
tree, best_combo = Find_Longest_tree(FILLED_anti_commuting_sets, max_set_size)

# want to maximise the anti_commutativity between the remaining terms to do further Unitary partitioning!
missing_k = [k for k in anti_commuting_sets.keys() if k not in [key for index, key in best_combo['j_k']]]
