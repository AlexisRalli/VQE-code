...
class Hamiltonian_PySCF():
    ...
    def __init__(self, MoleculeName,
                 ...
                 basis='sto-3g', multiplicity=1, geometry=None):
    ...
    def Get_CCSD_Amplitudes(self):
        ...
        note that:
            - single amplitudes:A 2-dimension array t[a,i] for CCSD single excitation amplitudes
                                where a is virtual index and i is occupied index
            - doubles amplitudes: A 4-dimension array t[a,i,b,j] for CCSD double excitation amplitudes
