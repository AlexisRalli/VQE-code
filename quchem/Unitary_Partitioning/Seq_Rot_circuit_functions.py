...
from quchem.Misc_functions.Misc_functions import lexicographical_sort, choose_Pn_index
from quchem.Qcircuit.Ansatz_quantum_circuit_functions import Circuit_from_list_PauliWords
def Build_R_SeqRot_Q_circuit_STAIRS_Reduced(anti_commuting_set, N_Qubits, check_reduction_lin_alg=False, atol=1e-8, rtol=1e-05, check_circuit=False):
    """
    ...
    number of cancellations in rotation circuits.
    ...
    lex_sorted_AC_set = lexicographical_sort(anti_commuting_set)
    S_index = choose_Pn_index(lex_sorted_AC_set)

    X_sk_theta_sk_list, full_normalised_set, Ps, gamma_l = Get_Xsk_op_list(lex_sorted_AC_set,
                                                                            S_index, 
                                                                            N_Qubits,
                                                                             check_reduction=check_reduction_lin_alg,
                                                                              atol=atol, 
    ...
    full_RS_circuit = Circuit_from_list_PauliWords(op_list, angle_list)
